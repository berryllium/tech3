        ...
        <div class="tabs__content">
          ...
          <div class="tabs__item" v-if="this.tab=='deliv'">
            <h4>Доставка по Москве и МО</h4>
              <li>Доставка по Москве в течение 2 часов</li>
              <li>Стоимость доставки 350р</li>
              <li>Стоимость доставки по МО от 400р</li>
          </div>
          <div class="tabs__item" v-if="this.tab=='deliv'">
            <h4>Оплата</h4>
              <li>Оплата производится при получении и после проверки товара</li>
              <li>Возможно оплата наличными или переводом</li>
          </div>
